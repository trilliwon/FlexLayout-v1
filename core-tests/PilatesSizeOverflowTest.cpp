...
// @Generated by gentest/gentest.rb from gentest/fixtures/PilatesSizeOverflowTest.html

#include <gtest/gtest.h>
#include <pilates/Pilates.h>

TEST(PilatesTest, nested_overflowing_child) {
  ...
  PilatesNodeStyleSetWidth(root_child0_child0, 200);
  PilatesNodeStyleSetHeight(root_child0_child0, 200);
  ...
  ASSERT_FLOAT_EQ(-100, PilatesNodeLayoutGetLeft(root_child0_child0));
  ASSERT_FLOAT_EQ(0, PilatesNodeLayoutGetTop(root_child0_child0));
  ASSERT_FLOAT_EQ(200, PilatesNodeLayoutGetWidth(root_child0_child0));
  ASSERT_FLOAT_EQ(200, PilatesNodeLayoutGetHeight(root_child0_child0));
...
TEST(PilatesTest, nested_overflowing_child_in_constraint_parent) {
  const PilatesConfigRef config = PilatesConfigNew();
...
TEST(PilatesTest, parent_wrap_child_size_overflowing_parent) {
  const PilatesConfigRef config = PilatesConfigNew();
